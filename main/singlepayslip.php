...
$result=mysql_query("SELECT * FROM payroll_tbl WHERE payrollrun='$period' and id='$id'");
while($row=mysql_fetch_array($result)){
    $sid=$row['staffid'];
    $s=mysql_fetch_array(mysql_query("SELECT st.type_name as stype, s.national_id as natid ,s.accountno as bankacc ,s.bankcode as bcode FROM staff s  inner join stafftype st on st.id=s.staff_type  where s.id='$sid'"));
    $bcode=$s['bcode'];
