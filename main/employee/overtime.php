...
if ($period=="all") {
    $seresult=mysql_query("SELECT * FROM empvsovertime where empid='$user' ");
}elseif ($period!="all") {
    $seresult=mysql_query("SELECT * FROM empvsovertime where empid='$user' and period='$period' order by id desc ");
}
?>
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-5">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="selectreport.php">REPORTS</a>
                        </li>
                        <li class="active">
                            <strong><a href="#">OVERTIME REPORT</a></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
