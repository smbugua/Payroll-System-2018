 ...
 <div class="row wrapper border-bottom white-bg page-heading">
  	...
  	?>
                            ...
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $row['staff_name']?></strong></h4>
                                ...
                                <p>
                                   Email:<input type="email" class="form-control" name="email" value="<?php echo $row['staff_email']?>">  <br>
                                   Username:<input type="text" class="form-control" name="uname" value="<?php echo $row['payrollno']?>" readonyly="">  <br>
