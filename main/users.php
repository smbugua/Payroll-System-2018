                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="adduser.php" class="btn btn-primary btn-xs">New Users</a>
                            </div>
                        </div>
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
        ...
        <h4>Users Details</h4>         
                ...
                <tr> 
                    ...
                    <th class="header" id="usr">Account Type</th>
            ...
            <?php while ($row = mysql_fetch_array($result)) { ?>           
                <tr > 
                    ...
                    if ($u==0) {
                        ...
                        $acc="Molars Front Office";
                    }
                    echo "<td>$acc</td>";
                    ?>
                       <td><a class="btn btn-danger btn-xs" href="userclass.php?id=<?php echo $row["id"]?>&action=deleteuser">Delete</a></td>
