...
if ($period=="all") {
    $seresult=mysql_query("SELECT * FROM empvsovertime where status='1'");
}elseif ($period!="all") {
    $seresult=mysql_query("SELECT * FROM empvsovertime where status='1' and period='$period'");
}
?>
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-5">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong><a href="#">APPROVED OVERTIME REQUESTS</a></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="wrapper wrapper-content animated fadeInUp">
                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>APPROVED OVERTIME REQUESTS</h5>
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
         <thead>
          <th colspan="11" >
           <h4>APPROVED OVERTIME REQUESTS</h4>            
             </th>
