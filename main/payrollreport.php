...
$result=mysql_query("SELECT DISTINCT * FROM payroll WHERE status='0' and payrollrun='$period' ORDER BY id ASC ");
                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="payrollclass.php?action=confirmpayroll" class="btn btn-primary btn-xs">Review and Confrim Payroll</a>
                            </div>
                        </div>
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
        ...
        <h4>Payroll Details <?php echo $period?></h4>         
             </th>
