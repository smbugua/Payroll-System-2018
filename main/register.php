...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            ...
            <h3>Register to INCOUNTY+</h3>
            <p>Create account to see it in action.</p>
            <form class="m-t" role="form" action="signup.php" method="post">
                ...
                <div class="form-group" id="err">
                 ...
                 <div class="form-group">
                    <input type="password" id="p2"  class="form-control" name="password2" placeholder="Password" required="" 
                    >
                </div>
                <div class="form-group">
                        <div class="checkbox i-checks"><label> <input type="checkbox"><i></i> Agree the terms and policy </label></div>
                </div>
                <button type="submit" class="btn btn-primary block full-width m-b" onclick="validater()">Register</button>
